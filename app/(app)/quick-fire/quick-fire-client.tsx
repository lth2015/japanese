...
import {
  getNextQuickFireSentence,
  submitQuickFireAttempt,
} from "@/lib/actions/quick-fire"
import type { Sentence } from "@/lib/db/schema"
import { diff, type DiffSegment } from "@/lib/diff"
import { stageLabel } from "@/lib/progress"
import { isSttSupported, startJapaneseSTT, type SttListener } from "@/lib/speech"
          ...
          <div className="relative h-48 w-48 grid place-items-center">
            <svg className="absolute inset-0 -rotate-90" viewBox="0 0 100 100">
              ...
              <circle
                ...
                strokeDashoffset={`${
                  inCountdown
                    ? 2 * Math.PI * 46 * (1 - remainingCountdown / COUNTDOWN_SEC)
                    : 0
                }`}
            ...
            <div className="flex flex-col items-center gap-1">
              {inCountdown ? (
                ...
                <>
                  <Mic className="h-12 w-12 text-success animate-pulse-record" strokeWidth={1.5} />
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                <ScoreTile
                  ...
                  hint={
                    firstWordSec === null
                      ? "未开口"
                      : `${(firstWordSec / 1000).toFixed(1)}s 起步`
                  }
                  weight="60%"
                  highlight
                />
